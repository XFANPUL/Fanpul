...
public class OrdersListAdapter {
    ...
    public HistoryListAdapter CreateHistoryListAdapter(Context context, List<Order> list) {
        return new HistoryListAdapter(context, list);
    }
    ...
    class QueuingHolder extends RecyclerView.ViewHolder {    //排队中
        ...
        public void bindHolder(final Queue queue) {
            ...
            DBConnection.queryRestaurantByName(queue.getRestaurantName(), new OneObjectCallBack<Restaurant>() {
                @Override
                public void Success(Restaurant result) {
            ...
            if(!queue.isArrived()) { //没到号时
                DBConnection.getPreTableNumber(queue, new OneObjectCallBack<Integer>() {
                    @Override
    ...
    class PreCommentHolder extends RecyclerView.ViewHolder {    //待评论的RecyclerView.Holder
        ...
        @Bind(R.id.btn_order_toeva_eva)
        Button btn_order_toeva_eva;
        ...
        public void bindHolder(final Order order) {
            ...
            btn_order_toeva_eva.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    class HistoryListAdapter extends RecyclerView.Adapter<HistoryHolder> {
        private Context context;
        private List<Order> list;

        public HistoryListAdapter(Context context, List<Order> list) {
            this.context = context;
            this.list = list;
        }
    ...
    class HistoryHolder extends RecyclerView.ViewHolder {    //待评论的RecyclerView.Holder
        @Bind(R.id.ordered_toeva_name)
        TextView shop_name_inline;
        @Bind(R.id.orderdshop_img)
        ImageView orderdShopImg;
        ...
        public void bindHolder(final Order order) {
            ...
            btn_order_toeva_mybook.setVisibility(View.GONE);
            btn_order_toeva_eva.setVisibility(View.GONE);
