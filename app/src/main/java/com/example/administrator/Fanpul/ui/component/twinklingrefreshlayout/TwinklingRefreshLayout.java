package com.example.administrator.Fanpul.ui.component.twinklingrefreshlayout;
...
import com.example.administrator.Fanpul.ui.component.twinklingrefreshlayout.header.GoogleDotView;
import com.example.administrator.Fanpul.ui.component.twinklingrefreshlayout.utils.DensityUtil;
import com.example.administrator.Fanpul.ui.component.twinklingrefreshlayout.utils.ScrollingUtil;
...
public class TwinklingRefreshLayout extends RelativeLayout {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWaveHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_wave_height, DensityUtil.dp2px(context, 120));
