...
public class AdapterManager {  //adapter管理类
    ...
    //得到订单完成的适配器
    public static RecyclerView.Adapter getHistoryAdapter(Context context, List<Order> tList ){
        return  new OrdersListAdapter().CreateHistoryListAdapter(context,tList);
    }
}
