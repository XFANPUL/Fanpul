...
public class MenuInDetailActivity extends BaseSwipeBackActivity {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        DBProxy.proxy.judgeIsCollectionMenu("张三", menu, new OneObjectCallBack<Boolean>() {
            @Override
        ...
        if (flag) {
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DBProxy.proxy.deleteCollectionMenu("张三", menu, new OneObjectCallBack() {
                        @Override
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    DBProxy.proxy.addCollectionMenu("张三", menu, new OneObjectCallBack() {
                        @Override
                        public void Success(Object result) {
                            updateUI(true);
                        }
