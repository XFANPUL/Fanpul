        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (payWays == null || payWays.equals(" ")) {
                    ...
                    ToastUtil.showToast(getActivity(),getString(R.string.toast_msg_pay_failed));
                    ...
                    order.save(new SaveListener<String>() {
                        ...
                        public void done(String s, BmobException e) {
                            if (e == null) {
                                Log.i("SuccessASS", s);
                                DBProxy.proxy .updateQueue(queue, order);
                            } else {
                    ...
                    StartActivityManager.startActivity(getActivity(), OrderFormActivity.class,order);
                    getActivity().finish();
                }
            }
        });
