...
public class DBConnection {
    public static void queryBmobObject(String bql, final DBQueryCallback callback) {
        Log.i("BQL", bql);
    ...
    //通过用户名查找排队情况
    public static void queryQueueByUserName(String userName, final DBQueryCallback callBack) {
    ...
    //通过用户名查找订单
    public static void queryOrderByUserName(String userName, Integer state, final DBQueryCallback callback) {
    ...
    //通过店铺名查找菜单类别
    public static void queryRestaurantCategory(String restaurantName, final DBQueryCallback callback) {
        String bql = "select * from Restaurant where restaurantName = '" + restaurantName + "'";
        new BmobQuery<Restaurant>().doSQLQuery(bql, new SQLQueryListener<Restaurant>() {
            @Override
            public void done(BmobQueryResult<Restaurant> bmobQueryResult, BmobException e) {
    ...
    //通过菜品类别查找菜品
    public static void queryMenuByCategory(MenuCategory menuCategory, final DBQueryCallback callback) { //通过菜品种类查找菜品
    ...
    //通过店铺名查找排队列表
    public static void queryQueueByResName(String restaurantName, final DBQueryCallback DBQueryCallback) {
    ...
    //通过店铺名查找排队列表
    public static void queryQueueByResNameAndTableSize(String restaurantName, String tableSize, final DBQueryCallback DBQueryCallback) {
        String bql = "select * from Queue where " +
    ...
    public static void updateOrderEvaluate1(Order order,int state) {
    ...
    public static void queryCollectionMenubyUserName(String userName, final DBQueryCallback callback) {
    ...
    public static void judgeIsCollectionMenu(final String userName, final Menu menu, final OneObjectCallBack callBack) {
        String sql = "Select * from CollectionMenu where userName = '" + userName + "'";
        new BmobQuery<CollectionMenu>().doSQLQuery(sql, new SQLQueryListener<CollectionMenu>() {
            @Override
            public void done(BmobQueryResult<CollectionMenu> bmobQueryResult, BmobException e) {
    ...
    public static void addCollectionMenu(final String userName, final Menu menu, final OneObjectCallBack callBack) {
    ...
    public static void deleteCollectionMenu(final String userName, final Menu menu, final OneObjectCallBack callBack) {
        String sql = "Select * from CollectionMenu where userName = '" + userName + "'";
        new BmobQuery<CollectionMenu>().doSQLQuery(sql, new SQLQueryListener<CollectionMenu>() {
            @Override
            public void done(BmobQueryResult<CollectionMenu> bmobQueryResult, BmobException e) {
    ...
    public static void judgeIsCollectionRestaurant(String userName, Restaurant restaurant, final OneObjectCallBack callback) {
    ...
    public static void operationCollectionRestaurant(final String operation, final String userName, final Restaurant restaurant, final OneObjectCallBack callBack) {
...
//删除收藏的店铺，这是最后哟个restaurant,所以将收藏的这一列删除
    public static void removeCollectionRestaurant(final OneObjectCallBack callBack, CollectionRestaurant coll) {
    ...
    //删除收藏的店铺，在关系的数量大于1
    public static void deleteCollectionRestaurant(String userName, final Restaurant restaurant, final OneObjectCallBack callBack, CollectionRestaurant coll) {
    ...
    public static void updateCollectionRestaurant(String userName, final Restaurant restaurant, final OneObjectCallBack callBack, CollectionRestaurant coll) {
        BmobRelation bmobRelation = new BmobRelation();
    ...
    public static void addCollectionRestaurant(String userName, Restaurant restaurant, final OneObjectCallBack callBack) {//开始时添加收藏的店铺
    ...
    public static void getCollectionRestaurant(String userName, final DBQueryCallback callback) {//根据姓名得到收藏的店铺
        String sql = "Select * from CollectionRestaurant where userName = '" + userName + "'";
        new BmobQuery<CollectionRestaurant>().doSQLQuery(sql, new SQLQueryListener<CollectionRestaurant>() {
            @Override
            public void done(BmobQueryResult<CollectionRestaurant> bmobQueryResult, BmobException e) {
    ...
    public static void getEvaluateRestaurant(Restaurant restaurant, final DBQueryCallback callback){
    ...
    public static void getEvaluateRestaurantByUserName(String userName, final DBQueryCallback callback){
