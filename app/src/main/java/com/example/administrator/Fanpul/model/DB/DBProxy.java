...
public class DBProxy implements DBInterface {
    ...
    public static DBProxy getProxy(String connection) {
        if(proxy == null){
           proxy = new DBProxy(connection);
        }
        return proxy;
    }
    ...
    public DBProxy(String connection) {
        this.DBConnection = getDBConnection(connection);
    }

    public DBInterface getDBConnection(String connection) {
        switch (connection) {
            case Constants.BMOB_CONNECTION:
                return BmobDBConnection.getBmobDBConnection();
            default:
                return null;
        }
    }
