...
public class ShopFragment extends BaseFragment {
    ...
    protected void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        shopinner_sale.setText(getString(R.string.sale_num,restaurant.getOrder()) );
        shopinner_score.setText("评分" + restaurant.getScore());
        shopinner_description.setText(restaurant.getDescription());

        DBProxy.proxy .judgeIsCollectionRestaurant(getString(R.string.user_name), restaurant, new OneObjectCallBack<Boolean>() {
            @Override
        ...
        if (result) {
            ...
            shop_collect.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    DBProxy.proxy .operationCollectionRestaurant("delete", getString(R.string.user_name), restaurant, new OneObjectCallBack() {
                        @Override
            ...
            shop_collect.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DBProxy.proxy .operationCollectionRestaurant("add",getString(R.string.user_name), restaurant, new OneObjectCallBack() {
                        @Override
                        public void Success(Object result) {
                            updateUI(true);
                        }
