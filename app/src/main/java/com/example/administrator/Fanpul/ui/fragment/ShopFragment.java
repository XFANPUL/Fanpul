...
public class ShopFragment extends BaseFragment {
    ...
    protected void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DBConnection.judgeIsCollectionRestaurant("张三", restaurant, new OneObjectCallBack<Boolean>() {
            @Override
        ...
        if (result) {
            ...
            shop_collect.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    DBConnection.operationCollectionRestaurant("delete", "张三", restaurant, new OneObjectCallBack() {
                        @Override
            ...
            shop_collect.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DBConnection.operationCollectionRestaurant("add", "张三", restaurant, new OneObjectCallBack() {
                        @Override
                        public void Success(Object result) {
                            updateUI(true);
                        }
