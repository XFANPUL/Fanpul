...
public class QueueFragment extends BaseFragment {   //排队的fragment
    ...
    protected void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DBProxy.proxy .queryRestaurantByBql(bql, new DBQueryCallback<Restaurant>() {
            ...
            public void Success(List<Restaurant> bmobObjectList) {
                ...
                DBProxy.proxy .queryQueueByResName(restaurant1.getRestaurantName(), new DBQueryCallback<Queue>() {
                    @Override
        ...
        showed_wb.setOnClickListener(new View.OnClickListener() {  //book我要点单
            ...
            public void onClick(View v) {
                ...
                DBProxy.proxy .RemoveRestaurantTableIndex(restaurant.getRestaurantName(), tableSize,
                        new OneObjectCallBack<Integer>() {
                            ...
                            public void Success(Integer tableNumber) {
                                ...
                                eating.setUserName(getString(R.string.user_name));
                    ...
                    public void onClick(View v) {
                        ...
                        queue.save(new SaveListener<String>() {
                            ...
                            public void done(String s, BmobException e) {
                                ...
                                ToastUtil.showToast(getActivity(),getString(R.string.toast_msg_failed));
    ...
    public void updateUI(List<Queue> bmobObjectList, Restaurant restaurant1) {
        ...
        if (smallTableLeft > 0) {
            ...
            DBProxy.proxy .getEatingByIndex(Math.abs(smallTableLeft% restaurant.getSmalltableNum()),"A",restaurant, new OneObjectCallBack<Long>() {
                @Override
        ...
        if (middleTableLeft > 0) {
            ...
            DBProxy.proxy .getEatingByIndex(Math.abs(middleTableLeft% restaurant.getMiddletableNum()),"B",restaurant, new OneObjectCallBack<Long>() {
                @Override
                public void Success(Long result) {
                    if(tableSize.equals("B")){
                        curTableTime = result;
        ...
        if (bigTableLeft > 0) {
            ...
            DBProxy.proxy .getEatingByIndex(Math.abs(bigTableLeft%restaurant.getBigtableNum()),"C",restaurant, new OneObjectCallBack<Long>() {
                @Override
                public void Success(Long result) {
                    if(tableSize.equals("C")){
                        curTableTime = result;
