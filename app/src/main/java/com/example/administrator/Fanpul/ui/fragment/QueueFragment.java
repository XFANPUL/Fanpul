...
public class QueueFragment extends BaseFragment {   //排队的fragment
    ...
    protected void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DBConnection.queryBmobObject(bql, new DBQueryCallback<Restaurant>() {
            ...
            public void Success(List<Restaurant> bmobObjectList) {
                ...
                DBConnection.queryQueueByResName(restaurant1.getRestaurantName(), new DBQueryCallback<Queue>() {
                    @Override
        ...
        showed_wb.setOnClickListener(new View.OnClickListener() {  //book我要点单
            ...
            public void onClick(View v) {
                ...
                DBConnection.RemoveRestaurantTableIndex(restaurant.getRestaurantName(), tableSize,
    ...
    public void updateUI(List<Queue> bmobObjectList, Restaurant restaurant1) {
        ...
        if (smallTableLeft > 0) {
            ...
            DBConnection.getEatingByIndex(Math.abs(smallTableLeft% restaurant.getSmalltableNum()),"A",restaurant, new OneObjectCallBack<Long>() {
                @Override
        ...
        if (middleTableLeft > 0) {
            ...
            DBConnection.getEatingByIndex(Math.abs(middleTableLeft% restaurant.getMiddletableNum()),"B",restaurant, new OneObjectCallBack<Long>() {
                @Override
                public void Success(Long result) {
                    if(tableSize.equals("B")){
                        curTableTime = result;
        ...
        if (bigTableLeft > 0) {
            ...
            DBConnection.getEatingByIndex(Math.abs(bigTableLeft%restaurant.getBigtableNum()),"C",restaurant, new OneObjectCallBack<Long>() {
                @Override
                public void Success(Long result) {
                    if(tableSize.equals("C")){
                        curTableTime = result;
